...
* **Łączenie gracza z serverem**
    - Przykładowe połączenie
        - `data = struct.pack('iff', 1, 10.5, 20.0)` 
        - `s = socket.socket()` 
...
* **Profile Gracza** - **Self ID** - rozpoznawanie którym sie jest
...
* **Tekstury** - podstawowe tekstury użyte w grze
    
* **Gra** - **Interpolacja liniowa (Lerp):** To magiczne słowo, które sprawi, że gra będzie płynna. Zamiast `x = nowa_pozycja`, robisz `x += (nowa_pozycja - x) * 0.1`.
